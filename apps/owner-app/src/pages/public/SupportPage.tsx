                    ...
                    <Grid container spacing={4} sx={{ flexDirection: isRTL ? 'row-reverse' : 'row' }}>
                        <Grid item xs={12} md={4}>
                            <Box sx={{ p: 3, bgcolor: 'rgba(255,255,255,0.01)', borderRadius: 2, textAlign: 'center' }}>
                                ...
                                <Typography variant="h6" color="white" fontWeight="700">{t('support.email')}</Typography>
                        ...
                        <Grid item xs={12} md={4}>
                            <Box sx={{ p: 3, bgcolor: 'rgba(255,255,255,0.01)', borderRadius: 2, textAlign: 'center' }}>
                                ...
                                <Typography variant="h6" color="white" fontWeight="700">{t('support.phone')}</Typography>
                        ...
                        <Grid item xs={12} md={4}>
                            <Box sx={{ p: 3, bgcolor: 'rgba(255,255,255,0.01)', borderRadius: 2, textAlign: 'center' }}>
                                ...
                                <Typography variant="h6" color="white" fontWeight="700">{t('support.office')}</Typography>
                                <Typography variant="body2" color="textSecondary">{t('support.office_address')}</Typography>
                            </Box>
                        </Grid>
                    </Grid>

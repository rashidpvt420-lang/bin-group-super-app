...
const strictHelper = `function replaceExact(relativePath, before, after, expectedCount = 1) {
...
const idempotentHelper = `function replaceExact(relativePath, before, after, expectedCount = 1) {
  const source = read(relativePath);

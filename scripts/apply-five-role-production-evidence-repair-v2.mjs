...
const fail = (message) => {
  throw new Error(`[five-role-evidence-repair-v2] ${message}`);
};
...
function update(path, transform) {
  ...
  console.log(`[five-role-evidence-repair-v2] updated ${path}`);
}
...
`);
console.log(`[five-role-evidence-repair-v2] created ${regressionPath}`);

for (const temporaryPath of [
  '.github/workflows/owner-five-role-evidence-repair-command.yml',
  'scripts/apply-five-role-production-evidence-repair.mjs',
  '.github/workflows/owner-five-role-evidence-repair-command-v2.yml',
  'scripts/apply-five-role-production-evidence-repair-v2.mjs',
]) {
  unlinkSync(temporaryPath);
  console.log(`[five-role-evidence-repair-v2] removed temporary bootstrap ${temporaryPath}`);
}

console.log('[five-role-evidence-repair-v2] PASS');

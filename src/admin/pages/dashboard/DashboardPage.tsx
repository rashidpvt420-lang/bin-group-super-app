...
export default function DashboardPage() {
    ...
    const [kpis, setKpis] = useState<Record<string, KPIState>>({
        totalProperties: { label: 'Total Properties', value: null, status: 'loading', icon: <Home size={18} />, color: '#3b82f6', path: '/admin/properties' },
        totalUnits: { label: 'Total Units', value: null, status: 'loading', icon: <Building2 size={18} />, color: '#8b5cf6' },
        activeTenants: { label: 'Active Tenants', value: null, status: 'loading', icon: <Users size={18} />, color: '#10b981', path: '/admin/tenants' },
        pendingTenantInvites: { label: 'Pending Invites', value: null, status: 'loading', icon: <Users size={18} />, color: '#f59e0b' },
        openMissions: { label: 'Open Missions', value: null, status: 'loading', icon: <Wrench size={18} />, color: '#f59e0b', path: '/admin/tickets' },
        emergencyRequests: { label: 'Emergency (SOS)', value: null, status: 'loading', icon: <AlertTriangle size={18} />, color: '#ef4444', path: '/admin/sos' },
        activeTechnicians: { label: 'Active Technicians', value: null, status: 'loading', icon: <Wrench size={18} />, color: '#10b981', path: '/admin/technicians' },
        activeBrokers: { label: 'Active Brokers', value: null, status: 'loading', icon: <Briefcase size={18} />, color: '#8b5cf6', path: '/admin/broker' },
        ...
        pendingPaymentVerifications: { label: 'Payment Verifications', value: null, status: 'loading', icon: <DollarSign size={18} />, color: '#f59e0b', path: '/admin/manual-approvals' },
        activeContracts: { label: 'Active Contracts', value: null, status: 'loading', icon: <FileText size={18} />, color: '#10b981' },
        propertyPassports: { label: 'Property Passports', value: null, status: 'loading', icon: <FileText size={18} />, color: '#3b82f6', path: '/admin/properties/passport' },
        documentsUploaded: { label: 'Documents', value: null, status: 'loading', icon: <FileText size={18} />, color: '#8b5cf6', path: '/admin/document-vault' },
        auditEventsToday: { label: 'Audit Events Today', value: null, status: 'loading', icon: <Activity size={18} />, color: '#3b82f6', path: '/admin/audit' },
        orphanRecords: { label: 'Orphan Records', value: null, status: 'loading', icon: <FileWarning size={18} />, color: '#ef4444', path: '/admin/orphans' },
        totalCollections: { label: 'Total Collections', value: null, status: 'loading', icon: <DollarSign size={18} />, color: '#10b981', path: '/admin/transactions' },
        ...
        payrollPending: { label: 'Payroll Pending', value: null, status: 'loading', icon: <Gavel size={18} />, color: '#f59e0b', path: '/admin/financials/payroll' }
    });
            ...
            <Box sx={{ pb: 8 }}>
                ...
                <Box sx={{ mb: 4 }}>
                    <Stack direction="row" spacing={2} sx={{ overflowX: 'auto', pb: 1, '&::-webkit-scrollbar': { height: 4 } }}>
                        <Button startIcon={<Plus />} variant="contained" onClick={() => navigate('/admin/onboard-property')}>Add Property</Button>
                        <Button startIcon={<Upload />} sx={{ bgcolor: 'rgba(255,255,255,0.05)', color: '#fff' }} onClick={() => navigate('/admin/bulk-import')}>Import Tenants</Button>
                        <Button startIcon={<CheckCircle2 />} sx={{ bgcolor: 'rgba(255,255,255,0.05)', color: '#fff' }} onClick={() => navigate('/admin/manual-approvals')}>Verify Payments</Button>
                        <Button startIcon={<FileText />} sx={{ bgcolor: 'rgba(255,255,255,0.05)', color: '#fff' }} onClick={() => navigate('/admin/document-vault')}>Document Vault</Button>
                        ...
                        <Button startIcon={<Shield />} sx={{ bgcolor: 'rgba(255,255,255,0.05)', color: '#fff' }} onClick={() => navigate('/admin/orphans')}>Orphan War Room</Button>
                        <Button startIcon={<Activity />} sx={{ bgcolor: 'rgba(255,255,255,0.05)', color: '#fff' }} onClick={() => navigate('/admin/ops/technicians')}>Duty Command</Button>
                        <Button startIcon={<TrendingUp />} sx={{ bgcolor: 'rgba(255,255,255,0.05)', color: '#fff' }} onClick={() => navigate('/admin/reports')}>Admin Report</Button>
                    </Stack>
                </Box>
                ...
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} lg={4}>
                        <Paper sx={{ p: 3, borderRadius: 6, bgcolor: '#0f172a', border: '1px solid rgba(255,255,255,0.05)' }}>
                            ...
                            <Stack spacing={3}>
                                ...
                                <Button fullWidth variant="outlined" sx={{ mt: 1 }} onClick={() => navigate('/admin/transactions')}>FULL LEDGER ACCESS</Button>
                            </Stack>
                        </Paper>
                    </Grid>
                    ...
                    <Grid item xs={12} lg={4}>
                        <Paper sx={{ p: 3, borderRadius: 6, bgcolor: '#0f172a', border: '1px solid rgba(255,255,255,0.05)' }}>
                            ...
                            <Button fullWidth variant="outlined" sx={{ mt: 3 }} onClick={() => navigate('/admin/document-vault')}>OPEN VAULT</Button>
                        </Paper>
                    </Grid>
                                    ...
                                    <Box key={log.id} sx={{ display: 'flex', gap: 2 }}>
                                        ...
                                        <Box>
                                            <Typography variant="body2" sx={{ fontWeight: 700, lineHeight: 1.2 }}>
                                                {String(log.actor || 'SYSTEM')} <Box component="span" sx={{ color: 'rgba(255,255,255,0.5)', fontWeight: 400 }}>{String(log.action || 'ACTIVITY')}</Box>
                                            </Typography>

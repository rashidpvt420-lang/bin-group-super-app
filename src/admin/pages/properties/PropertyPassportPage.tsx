                ...
                <Table sx={{ borderCollapse: 'separate', borderSpacing: '0 12px' }}>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell sx={{ color: 'rgba(255,255,255,0.3)', border: 'none', fontWeight: 900, textTransform: 'uppercase', fontSize: '0.7rem', letterSpacing: 1 }}>Contract / Status</TableCell>
                                ...
                                <TableRow key={p.id} sx={{ 
                                     ...
                                     <TableCell sx={{ border: 'none', py: 3, borderRadius: '16px 0 0 16px' }}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                            ...
                                            <Box>
                                                ...
                                                <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.2)', fontSize: '0.65rem' }}>ID: {p.id} • Owner: {p.ownerId?.substring(0,8)}...</Typography>
                                            </Box>
                                        </Box>
                                    </TableCell>
                                    <TableCell sx={{ border: 'none' }}>
                                        <Stack spacing={1} alignItems="flex-start">
                                            <Chip 
                                                label={p.contractType || 'NO_CONTRACT'} 
                                                size="small" 
                                                sx={{ bgcolor: alpha(binThemeTokens.gold, 0.1), color: binThemeTokens.gold, fontWeight: 900, borderRadius: 1, fontSize: '0.65rem' }} 
                                            />
                                            <Chip 
                                                label={(p.status || 'ACTIVE').toUpperCase()} 
                                                size="small" 
                                                variant="outlined"
                                                sx={{ borderColor: p.status === 'maintenance' ? '#ef4444' : '#10b981', color: p.status === 'maintenance' ? '#ef4444' : '#10b981', fontWeight: 900, borderRadius: 1, fontSize: '0.65rem' }} 
                                            />
                                        </Stack>
                                    </TableCell>
                                    <TableCell sx={{ border: 'none' }}>

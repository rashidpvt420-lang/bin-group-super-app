    ...
    const roles = [
        {
            ...
            icon: <User size={40} />,
            desc: 'Portfolio intelligence, online contracts, payment activation and asset control.'
        },
        {
            id: 'tenant',
            label: tx('gateway.role.tenant', 'Continue as Tenant'),
            icon: <Users size={40} />,
            desc: 'Report complaints, track maintenance, chat with technicians and approve completed work.'
        },
        {
            id: 'technician',
            label: tx('gateway.role.technician', 'Continue as Technician'),
            icon: <Wrench size={40} />,
            desc: 'Mission dispatch, work start/finish updates, photos, chat and evidence-based work logs.'
        },
        {
            id: 'broker',
            label: tx('gateway.role.broker', 'Continue as Broker'),
            icon: <Briefcase size={40} />,
            desc: 'Referral management, owner leads and commission tracking.'
        }
    ];
            ...
            <Container maxWidth="lg" sx={{ py: { xs: 10, md: 15 }, position: 'relative', zIndex: 1 }}>
                <Box sx={{ textAlign: 'center', mb: 10 }}>
                    ...
                    <Typography variant="h6" sx={{ color: 'rgba(255,255,255,0.5)', fontWeight: 500 }}>
                        {tx('gateway.subtitle', 'Enter the BIN GROUP app using your approved role. Admin access is protected and not exposed on the public gateway.')}
                    </Typography>
                </Box>
                ...
                <Box sx={{ mt: 8, textAlign: 'center' }}>
                    <Chip
                        label="ADMIN ACCESS: use /admin after approved admin login"

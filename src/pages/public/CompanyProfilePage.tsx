...
const content: Record<'en' | 'ar', CompanyContent> = {
  en: {
    ...
    title: 'BIN GROUP',
    headline: 'The UAE property operations access layer for owners, tenants, technicians, brokers, and admin.',
    subline: 'BIN GROUP gives every approved profile direct access to the same operational truth: property maintenance, tenant requests, technician dispatch, payment proof, broker attribution, contracts, reports, GPS context, and before/after evidence inside one bilingual system everyone can open and understand in under a minute.',
  ...
  ar: {
    badge: 'ملف الشركة',
    title: 'BIN GROUP',
    headline: 'طبقة الوصول لإدارة وتشغيل العقارات في الإمارات للملاك والمستأجرين والفنيين والوسطاء والإدارة.',
    subline: 'BIN GROUP تمنح كل ملف معتمد وصولاً مباشراً إلى نفس الحقيقة التشغيلية: صيانة العقار، طلبات المستأجرين، إرسال الفنيين، إثبات الدفع، إسناد الوسيط، العقود، التقارير، سياق GPS، وصور قبل/بعد داخل نظام واحد ثنائي اللغة يفهمه أي شخص خلال أقل من دقيقة.',

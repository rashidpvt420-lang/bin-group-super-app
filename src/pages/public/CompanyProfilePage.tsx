...
const content: Record<'en' | 'ar', CompanyContent> = {
  en: {
    ...
    subline: 'BIN GROUP helps owners, tenants, technicians, and brokers understand property maintenance in under one minute: onboard, report, track, prove, approve, and manage from one trusted system. BIN GROUP Operations stays behind the scenes to verify payments, dispatch work, and protect the audit trail.',
    license: 'All Kind Building Projects Contracting LLC S.P.C · Licensed in Abu Dhabi, UAE · Trade licence available on request',
    stats: [['1 min', 'To understand'], ['4', 'Public portals'], ['8', 'UAE emirates'], ['Proof', 'Photos · GPS · Time']],
  ...
  ar: {
    ...
    subline: 'BIN GROUP تساعد المالك والمستأجر والفني والوسيط على فهم الصيانة خلال أقل من دقيقة: تسجيل، بلاغ، متابعة، إثبات، موافقة، وإدارة من نظام موثوق واحد. يبقى فريق عمليات BIN GROUP خلف الكواليس للتحقق من المدفوعات وتوزيع العمل وحماية سجل التدقيق.',
    license: 'All Kind Building Projects Contracting LLC S.P.C · مرخصة في أبوظبي، الإمارات · رخصة التجارة متاحة عند الطلب',
    stats: [['دقيقة', 'للفهم'], ['4', 'بوابات عامة'], ['8', 'إمارات'], ['إثبات', 'صور · موقع · وقت']],

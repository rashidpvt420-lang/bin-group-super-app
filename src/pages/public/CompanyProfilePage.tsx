...
const content = {
  en: {
    ...
    services: [
      ...
      ['Property Management', 'Owners see property status, costs, reports, and service history clearly.'],
      ['Technician Work', 'Field work is connected to job status, location context, and before/after proof.'],
      ['Broker Growth', 'Property leads and commission progress stay visible and organized.'],
      ['AI Concierge', 'Residents can describe the issue and the app helps classify the request.'],
      ['Property Passport', 'Each property keeps its contracts, tickets, evidence, invoices, and history together.'],
    ],
  ...
  ar: {
    ...
    services: [
      ...
      ['إدارة العقار', 'المالك يرى حالة العقار والتكلفة والتقارير وسجل الخدمة بوضوح.'],
      ['عمل الفني', 'العمل الميداني مرتبط بالحالة والموقع وصور قبل/بعد.'],
      ['نمو الوسيط', 'الفرص العقارية ومتابعة العمولة تبقى واضحة ومنظمة.'],
      ['المساعد الذكي', 'المستأجر يشرح المشكلة والتطبيق يساعد في تصنيف الطلب.'],
      ['جواز العقار', 'كل عقار يحتفظ بالعقود والتذاكر والإثبات والفواتير والتاريخ في مكان واحد.'],
    ],

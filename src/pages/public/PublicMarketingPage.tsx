...
const copy = {
  en: {
    ...
    companyServices: [
      ...
      ['Contract operations', 'Property profile, inspection visit, verified quote, 15% mobilization, payment verification, and activation.'],
    ...
    propertyPathDesc: 'The owner starts with property details and service scope, signs the application, and BIN GROUP conducts an in-person physical property inspection before locking the final quote and collecting the 15% mobilization deposit.',
    propertyDetails: [
    ...
    contractSteps: [
      ['1', 'Submit property application', 'The onboarding wizard captures the asset profile, ownership proof, and initial property location.'],
      ['2', 'Physical property inspection', 'BIN GROUP certified field technician conducts an on-site visit to verify condition and canonical GPS.'],
      ['3', 'Verified quote & contract lock', 'Server-authoritative final quote is generated from measured physical inspection findings.'],
      ['4', '15% mobilization payment', 'Exact 15% mobilization deposit is received via Cash or Cheque and verified by Admin.'],
      ['5', 'Contract activation', 'Owner dashboard unlocks with verified property passport, units, tenants, tickets, and reports.'],
    ],
  ...
  ar: {
    ...
    companyServices: [
      ...
      ['تشغيل العقود', 'ملف العقار، الفحص الميداني، عرض السعر المعتمد، دفعة 15٪، تحقق الدفع، وتفعيل العقد.'],
    ...
    propertyPathDesc: 'يبدأ المالك ببيانات العقار ونطاق الخدمة وتوقيع الطلب، ثم تُجري مجموعة بن زيارة فحص ميداني للعقار قبل تثبيت عرض السعر النهائي وتحصيل دفعة التعبئة 15٪.',
    propertyDetails: [
    ...
    contractSteps: [
      ['1', 'تقديم طلب العقار', 'يقوم معالج التسجيل بحفظ ملف الأصل وإثبات الملكية وتحديد الموقع المبدئي للعقار.'],
      ['2', 'الفحص الميداني للعقار', 'زيارة موقعية من فني مجموعة بن المعتمد للتحقق من الحالة الفعلية وموقع GPS المعتمد.'],
      ['3', 'تثبيت عرض السعر والعقد', 'إصدار عرض السعر النهائي المعتمد من الخادم بناءً على نتائج المعاينة والقياسات الفعلية.'],
      ['4', 'دفعة التعبئة 15٪', 'استلام والتحقق من مبلغ دفعة التعبئة 15٪ الدقيق نقداً أو بشيك من قبل الإدارة.'],
      ['5', 'تفعيل العقد ولوحة التحكم', 'تفتح لوحة المالك بالكامل مع جواز العقار المعتمد والوحدات والمستأجرين والتذاكر والتقارير.'],
    ],

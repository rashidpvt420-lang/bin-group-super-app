...
const copy = {
  ...
  ar: {
    ...
    propertyPathDesc: 'يبدأ المالك بتفاصيل العقار ونطاق الخدمة والمستندات وبيانات الموقع/GPS المقدمة. تنشئ BIN GROUP بعد ذلك زيارة ميدانية مرتبطة لكل عقار. لا يصبح المبلغ التجاري النهائي مستحقاً إلا بعد اكتمال جميع الفحوصات المطلوبة، ثم يتم التحقق من دفعة التفعيل الدقيقة بنسبة 15٪ قبل استكمال متطلبات التفعيل وفتح لوحة المالك.',
    propertyDetails: [

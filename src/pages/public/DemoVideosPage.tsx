...
const scenes: Record<Lang, DemoScene[]> = {
  en: [
    ...
    { id: 'gps', title: 'GPS Location Summary', subtitle: 'Nearest verified technician location shown against the property pin.', metric: 'Location summary', icon: <MapPin size={22} />, bullets: ['Rough arrival estimate', 'Straight-line distance', 'SLA active'], route: '/technicians', label: 'GPS OPERATIONS', photo: 'https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=1200&q=80' },

                ...
                <Grid container spacing={4}>
                    <Grid item xs={12} lg={7}>
                        <Paper sx={{ p: { xs: 2.2, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.6)', border: '1px solid rgba(255,255,255,0.05)' }}>
                            <Stack spacing={1.5} sx={{ mb: 3 }}>
                                ...
                                <Stack direction="row" flexWrap="wrap" gap={1}>
                                    {['Residential', 'Commercial', 'Hospitality', 'Healthcare', 'Government', 'Majlis', 'Industrial'].map((category) => (
                                        <Chip key={category} size="small" label={category} sx={{ height: 22, bgcolor: alpha(binThemeTokens.gold, 0.1), color: binThemeTokens.gold, fontWeight: 800, fontSize: 10, border: '1px solid ' + alpha(binThemeTokens.gold, 0.3) }} />
                                    ))}
                                </Stack>
                            </Stack>
                            ...
                            {activeProperty?.propertyType && (
                                <Box sx={{ mt: 3 }}>
                                    <Divider sx={{ borderColor: 'rgba(0,0,0,0.15)', mb: 3 }} />
                            ...
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6}>
                                        <TextField fullWidth size="small" label="Mosque name" value={mosqueProfile.mosqueName || ''} onChange={(e) => updateMosqueProfile({ mosqueName: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <TextField select fullWidth size="small" label="Emirate / Authority" value={mosqueProfile.emirate || 'Dubai'} onChange={(e) => updateMosqueProfile({ emirate: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                                            {UAE_EMIRATES.map((emirate) => <MenuItem key={emirate} value={emirate}>{emirate} — {getMosqueRegulatoryAuthority(emirate)}</MenuItem>)}
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="GFA sq.ft" value={mosqueProfile.grossFloorAreaSqft || 0} onChange={(e) => updateMosqueProfile({ grossFloorAreaSqft: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Age years" value={mosqueProfile.propertyAgeYears || 0} onChange={(e) => updateMosqueProfile({ propertyAgeYears: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Capacity" value={mosqueProfile.maxWorshipperCapacity || 0} onChange={(e) => updateMosqueProfile({ maxWorshipperCapacity: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Ramadan peak" value={mosqueProfile.ramadanPeakCapacity || 0} onChange={(e) => updateMosqueProfile({ ramadanPeakCapacity: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Wudu areas" value={mosqueProfile.wuduAreasCount || 0} onChange={(e) => updateMosqueProfile({ wuduAreasCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Carpet sqm" value={mosqueProfile.carpetAreaSqm || 0} onChange={(e) => updateMosqueProfile({ carpetAreaSqm: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Marble sqm" value={mosqueProfile.marbleAreaSqm || 0} onChange={(e) => updateMosqueProfile({ marbleAreaSqm: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Chandeliers" value={mosqueProfile.chandeliersCount || 0} onChange={(e) => updateMosqueProfile({ chandeliersCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="HVAC units" value={mosqueProfile.hvacUnitsCount || 0} onChange={(e) => updateMosqueProfile({ hvacUnitsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="CCTV cameras" value={mosqueProfile.cctvCameraCount || 0} onChange={(e) => updateMosqueProfile({ cctvCameraCount: Number(e.target.value) || 0, cctvInstalled: Number(e.target.value) > 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField select fullWidth size="small" label="CCTV resolution" value={mosqueProfile.cctvResolution || '4MP'} onChange={(e) => updateMosqueProfile({ cctvResolution: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                                            {['2MP', '4MP', '8MP', 'Mixed'].map((value) => <MenuItem key={value} value={value}>{value}</MenuItem>)}
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <TextField select fullWidth size="small" label="Mosque FM package" value={mosqueProfile.serviceScope || 'Full IFM'} onChange={(e) => updateMosqueProfile({ serviceScope: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                                            {['Basic MEP', 'Comprehensive AMC', 'Full IFM'].map((value) => <MenuItem key={value} value={value}>{value}</MenuItem>)}
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <TextField select fullWidth size="small" label="Contract structure" value={mosqueProfile.preferredContractStructure || 'Wakalah'} onChange={(e) => updateMosqueProfile({ preferredContractStructure: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                        ...
                        {isHotel && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}>
                                        <TextField select fullWidth size="small" label="Star rating" value={hotelProfile.starRating || 3} onChange={(e) => updateHotelProfile({ starRating: Number(e.target.value) })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                                            {[1, 2, 3, 4, 5].map((s) => <MenuItem key={s} value={s}>{s}★</MenuItem>)}
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Rooms" value={hotelProfile.roomsCount || 0} onChange={(e) => updateHotelProfile({ roomsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Beds" value={hotelProfile.bedsCount || 0} onChange={(e) => updateHotelProfile({ bedsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Conference rooms" value={hotelProfile.conferenceRoomsCount || 0} onChange={(e) => updateHotelProfile({ conferenceRoomsCount: Number(e.target.value) || 0, hasConferenceRoom: Number(e.target.value) > 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[
                                        ...
                                        <Chip key={key} label={label} onClick={() => updateHotelProfile({ [key]: !hotelProfile[key] })}
                                            sx={{ bgcolor: hotelProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: hotelProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${hotelProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                        ...
                        {isSchool && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6}>
                                        <TextField select fullWidth size="small" label="Institution type" value={schoolProfile.institutionType || 'School'} onChange={(e) => updateSchoolProfile({ institutionType: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                                            {['School', 'University', 'College', 'Vocational Institute', 'Nursery'].map((t) => <MenuItem key={t} value={t}>{t}</MenuItem>)}
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Student capacity" value={schoolProfile.studentCapacity || 0} onChange={(e) => updateSchoolProfile({ studentCapacity: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Classrooms" value={schoolProfile.classroomsCount || 0} onChange={(e) => updateSchoolProfile({ classroomsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Labs" value={schoolProfile.labsCount || 0} onChange={(e) => updateSchoolProfile({ labsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Sports courts" value={schoolProfile.sportsCourtCount || 0} onChange={(e) => updateSchoolProfile({ sportsCourtCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[
                                        ...
                                        <Chip key={key} label={label} onClick={() => updateSchoolProfile({ [key]: !schoolProfile[key] })}
                                            sx={{ bgcolor: schoolProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: schoolProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${schoolProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isHospital && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6}>
                                        <TextField select fullWidth size="small" label="Facility type" value={hospitalProfile.facilityType || 'Hospital'} onChange={(e) => updateHospitalProfile({ facilityType: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>
                                            {['Hospital', 'Specialist Clinic', 'Day Surgery', 'Polyclinic', 'Medical Centre'].map((t) => <MenuItem key={t} value={t}>{t}</MenuItem>)}
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Beds" value={hospitalProfile.bedsCount || 0} onChange={(e) => updateHospitalProfile({ bedsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Wards" value={hospitalProfile.wardsCount || 0} onChange={(e) => updateHospitalProfile({ wardsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="ICU beds" value={hospitalProfile.icuBeds || 0} onChange={(e) => updateHospitalProfile({ icuBeds: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Operating theaters" value={hospitalProfile.operatingTheatersCount || 0} onChange={(e) => updateHospitalProfile({ operatingTheatersCount: Number(e.target.value) || 0, hasOperatingTheaters: Number(e.target.value) > 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[
                                        ...
                                        <Chip key={key} label={label} onClick={() => updateHospitalProfile({ [key]: !hospitalProfile[key] })}
                                            sx={{ bgcolor: hospitalProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: hospitalProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${hospitalProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isStadium && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Seating capacity" value={stadiumProfile.seatingCapacity || 0} onChange={(e) => updateStadiumProfile({ seatingCapacity: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Pitches / fields" value={stadiumProfile.pitchesCount || 0} onChange={(e) => updateStadiumProfile({ pitchesCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="Courts" value={stadiumProfile.courtsCount || 0} onChange={(e) => updateStadiumProfile({ courtsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6} sm={3}>
                                        <TextField fullWidth size="small" type="number" label="VIP suites" value={stadiumProfile.vipSuitesCount || 0} onChange={(e) => updateStadiumProfile({ vipSuitesCount: Number(e.target.value) || 0, hasVIPSuite: Number(e.target.value) > 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[
                                        ...
                                        <Chip key={key} label={label} onClick={() => updateStadiumProfile({ [key]: !stadiumProfile[key] })}
                                            sx={{ bgcolor: stadiumProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: stadiumProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${stadiumProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isVilla && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Bedrooms" value={villaProfile.bedrooms || 3} onChange={(e) => updateVillaProfile({ bedrooms: Number(e.target.value) || 3 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Bathrooms" value={villaProfile.bathrooms || 3} onChange={(e) => updateVillaProfile({ bathrooms: Number(e.target.value) || 3 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Parking spaces" value={villaProfile.parkingSpaces || 2} onChange={(e) => updateVillaProfile({ parkingSpaces: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Garden sqm" value={villaProfile.gardenSqm || 0} onChange={(e) => updateVillaProfile({ gardenSqm: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasPrivatePool', label: 'Private Pool' }, { key: 'hasStaffQuarters', label: 'Staff Quarters' }, { key: 'hasBBQArea', label: 'BBQ Area' }, { key: 'hasSolarPanels', label: 'Solar Panels' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateVillaProfile({ [key]: !villaProfile[key] })} sx={{ bgcolor: villaProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: villaProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${villaProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isResidential && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Total units" value={residentialProfile.unitsCount || 0} onChange={(e) => updateResidentialProfile({ unitsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Avg bedrooms/unit" value={residentialProfile.avgBedrooms || 2} onChange={(e) => updateResidentialProfile({ avgBedrooms: Number(e.target.value) || 1 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Lifts" value={residentialProfile.liftsCount || 0} onChange={(e) => updateResidentialProfile({ liftsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Parking bays" value={residentialProfile.parkingBays || 0} onChange={(e) => updateResidentialProfile({ parkingBays: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasPool', label: 'Pool' }, { key: 'hasGym', label: 'Gym' }, { key: 'hasLobby', label: 'Lobby' }, { key: 'hasMaids', label: "Maid's Rooms" }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateResidentialProfile({ [key]: !residentialProfile[key] })} sx={{ bgcolor: residentialProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: residentialProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${residentialProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isCommercial && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Office units" value={commercialProfile.officesCount || 0} onChange={(e) => updateCommercialProfile({ officesCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Meeting rooms" value={commercialProfile.meetingRooms || 0} onChange={(e) => updateCommercialProfile({ meetingRooms: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Lifts" value={commercialProfile.liftsCount || 0} onChange={(e) => updateCommercialProfile({ liftsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Parking bays" value={commercialProfile.parkingBays || 0} onChange={(e) => updateCommercialProfile({ parkingBays: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasDataRoom', label: 'Server / Data Room' }, { key: 'hasCanteen', label: 'Cafeteria / Canteen' }, { key: 'hasPrayer', label: 'Prayer Room' }, { key: 'receptionAreas', label: 'Reception Lobby' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateCommercialProfile({ [key]: typeof commercialProfile[key] === 'boolean' ? !commercialProfile[key] : 1 })} sx={{ bgcolor: commercialProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: commercialProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${commercialProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isRetail && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Shops / units" value={retailProfile.shopsCount || 0} onChange={(e) => updateRetailProfile({ shopsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Food court units" value={retailProfile.foodCourtUnits || 0} onChange={(e) => updateRetailProfile({ foodCourtUnits: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Escalators" value={retailProfile.escalatorsCount || 0} onChange={(e) => updateRetailProfile({ escalatorsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Lifts" value={retailProfile.liftsCount || 0} onChange={(e) => updateRetailProfile({ liftsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasAnchorTenant', label: 'Anchor Tenant' }, { key: 'hasSecurity', label: 'Security / CCTV' }, { key: 'hasGym', label: 'Gym / Wellness' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateRetailProfile({ [key]: !retailProfile[key] })} sx={{ bgcolor: retailProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: retailProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${retailProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isWarehouse && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Loading bays" value={warehouseProfile.loadingBays || 0} onChange={(e) => updateWarehouseProfile({ loadingBays: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Shutter doors" value={warehouseProfile.shutterDoors || 0} onChange={(e) => updateWarehouseProfile({ shutterDoors: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Power load (KW)" value={warehouseProfile.powerLoadKW || 0} onChange={(e) => updateWarehouseProfile({ powerLoadKW: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Ceiling height (m)" value={warehouseProfile.ceilingHeightMeters || 6} onChange={(e) => updateWarehouseProfile({ ceilingHeightMeters: Number(e.target.value) || 6 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasSprinklers', label: 'Sprinkler System' }, { key: 'hasFirePump', label: 'Fire Pump' }, { key: 'hasMezzanine', label: 'Mezzanine Floor' }, { key: 'hasOfficeArea', label: 'Office Area' }, { key: 'hasHazmat', label: 'Hazmat Zone' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateWarehouseProfile({ [key]: !warehouseProfile[key] })} sx={{ bgcolor: warehouseProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: warehouseProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${warehouseProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isLabourCamp && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Total beds" value={labourCampProfile.bedsCount || 0} onChange={(e) => updateLabourCampProfile({ bedsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Blocks / buildings" value={labourCampProfile.blocksCount || 0} onChange={(e) => updateLabourCampProfile({ blocksCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Toilets per block" value={labourCampProfile.toiletsPerBlock || 4} onChange={(e) => updateLabourCampProfile({ toiletsPerBlock: Number(e.target.value) || 4 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Water tanks" value={labourCampProfile.waterTanksCount || 1} onChange={(e) => updateLabourCampProfile({ waterTanksCount: Number(e.target.value) || 1 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Kitchens" value={labourCampProfile.kitchensCount || 1} onChange={(e) => updateLabourCampProfile({ kitchensCount: Number(e.target.value) || 1 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Laundry units" value={labourCampProfile.laundryUnitsCount || 0} onChange={(e) => updateLabourCampProfile({ laundryUnitsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasPestControlZone', label: 'Pest Control Zone' }, { key: 'hasFireSafety', label: 'Fire Safety' }, { key: 'hasCanteen', label: 'Canteen' }, { key: 'hasMedicalRoom', label: 'Medical Room' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateLabourCampProfile({ [key]: !labourCampProfile[key] })} sx={{ bgcolor: labourCampProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: labourCampProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${labourCampProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {(isGovernment) && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6}><TextField select fullWidth size="small" label="Property type" value={governmentProfile.govPropertyType || 'Government Office'} onChange={(e) => updateGovernmentProfile({ govPropertyType: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>{['Government Office', 'Authority / Department', 'Court Building', 'Ministry', 'Municipality', 'Police Station', 'Military Base'].map((v) => <MenuItem key={v} value={v}>{v}</MenuItem>)}</TextField></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Meeting rooms" value={governmentProfile.meetingRooms || 0} onChange={(e) => updateGovernmentProfile({ meetingRooms: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Staff count" value={governmentProfile.staffCount || 0} onChange={(e) => updateGovernmentProfile({ staffCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={12} sm={6}><TextField select fullWidth size="small" label="Security level" value={governmentProfile.securityLevel || 'Standard'} onChange={(e) => updateGovernmentProfile({ securityLevel: e.target.value })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}>{['Standard', 'Restricted', 'High Security', 'Sovereign'].map((v) => <MenuItem key={v} value={v}>{v}</MenuItem>)}</TextField></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasVIPArea', label: 'VIP Area' }, { key: 'hasCeremonialSpace', label: 'Ceremonial Space' }, { key: 'hasPublicServiceCounter', label: 'Public Counter' }, { key: 'hasDataCenter', label: 'Data Center' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateGovernmentProfile({ [key]: !governmentProfile[key] })} sx={{ bgcolor: governmentProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: governmentProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${governmentProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {(isGovMajlis || isPrivateMajlis) && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Guests capacity" value={majlisProfile.guestsCapacity || 0} onChange={(e) => updateMajlisProfile({ guestsCapacity: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Majlis rooms" value={majlisProfile.majlisRoomsCount || 1} onChange={(e) => updateMajlisProfile({ majlisRoomsCount: Number(e.target.value) || 1 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Garden sqm" value={majlisProfile.gardenSqm || 0} onChange={(e) => updateMajlisProfile({ gardenSqm: Number(e.target.value) || 0, hasGarden: Number(e.target.value) > 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Event halls" value={majlisProfile.eventHallsCount || 0} onChange={(e) => updateMajlisProfile({ eventHallsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasGarden', label: 'Garden / Courtyard' }, { key: 'hasKitchen', label: 'Kitchen / Pantry' }, { key: 'hasVIPRoom', label: 'VIP Room' }, { key: 'hasCarPark', label: 'Car Park' }, { key: 'hasCCTV', label: 'CCTV' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateMajlisProfile({ [key]: !majlisProfile[key] })} sx={{ bgcolor: majlisProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: majlisProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${majlisProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isMixedUse && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Residential floors" value={mixedUseProfile.residentialFloors || 0} onChange={(e) => updateMixedUseProfile({ residentialFloors: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Commercial floors" value={mixedUseProfile.commercialFloors || 0} onChange={(e) => updateMixedUseProfile({ commercialFloors: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Total units" value={mixedUseProfile.totalUnits || 0} onChange={(e) => updateMixedUseProfile({ totalUnits: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Lifts" value={mixedUseProfile.liftsCount || 0} onChange={(e) => updateMixedUseProfile({ liftsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Podium shops" value={mixedUseProfile.podiumShopsCount || 0} onChange={(e) => updateMixedUseProfile({ podiumShopsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasHotelComponent', label: 'Hotel Component' }, { key: 'hasServiced', label: 'Serviced Apartments' }, { key: 'hasPool', label: 'Pool' }, { key: 'hasGym', label: 'Gym' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateMixedUseProfile({ [key]: !mixedUseProfile[key] })} sx={{ bgcolor: mixedUseProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: mixedUseProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${mixedUseProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                        ...
                        {isFarm && (
                            <Paper sx={{ mt: 4, p: { xs: 2.5, sm: 4 }, borderRadius: 6, bgcolor: 'rgba(22, 22, 24, 0.72)', border: `1px solid ${alpha(binThemeTokens.gold, 0.35)}` }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Land acres" value={farmProfile.landAcres || 0} onChange={(e) => updateFarmProfile({ landAcres: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Irrigation zones" value={farmProfile.irrigationZones || 0} onChange={(e) => updateFarmProfile({ irrigationZones: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Pumps" value={farmProfile.pumpsCount || 0} onChange={(e) => updateFarmProfile({ pumpsCount: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Landscaping sqm" value={farmProfile.landscapingSqm || 0} onChange={(e) => updateFarmProfile({ landscapingSqm: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="External lighting pts" value={farmProfile.externalLightingPoints || 0} onChange={(e) => updateFarmProfile({ externalLightingPoints: Number(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                    <Grid item xs={6} sm={3}><TextField fullWidth size="small" type="number" label="Staff quarters" value={farmProfile.staffQuartersCount || 0} onChange={(e) => updateFarmProfile({ staffQuartersCount: Number(e.target.value) || 0, hasStaffQuarters: Number(e.target.value) > 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} /></Grid>
                                </Grid>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 3 }}>
                                    {[{ key: 'hasGenerator', label: 'Generator' }, { key: 'hasStorageBuilding', label: 'Storage Building' }, { key: 'hasPaddock', label: 'Paddock / Animal Area' }].map(({ key, label }) => (
                                        <Chip key={key} label={label} onClick={() => updateFarmProfile({ [key]: !farmProfile[key] })} sx={{ bgcolor: farmProfile[key] ? alpha(binThemeTokens.gold, 0.2) : 'rgba(0,0,0,0.07)', color: farmProfile[key] ? binThemeTokens.gold : '#374151', border: `1px solid ${farmProfile[key] ? alpha(binThemeTokens.gold, 0.5) : 'rgba(0,0,0,0.15)'}`, fontWeight: 900, cursor: 'pointer' }} />
                                    ))}
                                </Stack>
                                <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 2 }}>
                            ...
                            <Stack spacing={3}>
                                ...
                                <Box>
                                    ...
                                    <TextField
                                        ...
                                        sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }}
                                    >
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6}>
                                        <TextField fullWidth label={isMosque ? 'Wudu areas' : isHotel ? 'Rooms' : isSchool ? 'Classrooms' : isHospital ? 'Wards' : isStadium ? 'Capacity / 100' : t('onboarding.units')} type="number" size="small" value={activeProperty?.units || 0} onChange={(e) => updateProperty(0, { units: parseInt(e.target.value) || 0 })} InputProps={{ endAdornment: scanned ? <ShieldCheck size={16} color="#10b981" /> : null }} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <TextField fullWidth label={t('onboarding.floors')} type="number" size="small" value={activeProperty?.floors || 1} onChange={(e) => updateProperty(0, { floors: parseInt(e.target.value) || 1 })} InputProps={{ endAdornment: scanned ? <ShieldCheck size={16} color="#10b981" /> : null }} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <TextField fullWidth label={t('onboarding.sqft')} type="number" size="small" value={activeProperty?.sqft || 0} onChange={(e) => updateProperty(0, { sqft: parseInt(e.target.value) || 0 })} InputProps={{ endAdornment: scanned ? <ShieldCheck size={16} color="#10b981" /> : null }} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <TextField fullWidth label={t('onboarding.age')} type="number" size="small" value={activeProperty?.age || 0} onChange={(e) => updateProperty(0, { age: parseInt(e.target.value) || 0 })} sx={{ '& .MuiInputLabel-root': { color: 'rgba(0,0,0,0.6)' }, '& .MuiOutlinedInput-root': { color: '#111827' } }} />
                                    </Grid>
                                </Grid>

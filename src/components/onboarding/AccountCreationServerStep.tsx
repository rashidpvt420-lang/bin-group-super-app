  ...
  return (
    <Box dir={isRTL ? 'rtl' : 'ltr'} sx={{ maxWidth: 800, mx: 'auto', py: 2 }}>
      <Box sx={{ textAlign: 'center', mb: 3 }}>
        ...
        <Typography sx={{ color: 'rgba(255,255,255,.55)', mt: 1 }}>{label('onboarding.acc_creation_desc', 'Submit your owner registration to continue the contract and payment process.')}</Typography>
      </Box>

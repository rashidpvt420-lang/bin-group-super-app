        ...
        <Box sx={{ bgcolor: '#FFF', color: '#000', p: { xs: 2.5, md: 4 }, borderRadius: 2, mb: 4, position: 'relative', overflow: 'hidden', maxHeight: 760, overflowY: 'auto' }}>
          ...
          <AgreementSection title="1. Application Cover" ar="غلاف الطلب">
            <Grid container spacing={1.25}>
              ...
              <Grid item xs={12} md={6}><Typography variant="caption" color="text.secondary">15% mobilisation after visit / دفعة 15٪ بعد الزيارة</Typography><Typography variant="body2" fontWeight="950">{lockedQuote?.activationDeposit ? `AED ${formatAED(lockedQuote.activationDeposit)}` : copy('Pending server quote', 'بانتظار عرض الخادم')}</Typography></Grid>
            </Grid>
            <Divider sx={{ my: 2 }} />

...
// Contract v3: PR Validation dispatches its own production-protected certificate job.
const workflowPath = new URL('../../.github/workflows/pr-validation.yml', import.meta.url);
const workflow = await readFile(workflowPath, 'utf8');

test('v3 active PR Validation dispatches certificate export only from an exact draft owner request', () => {
...
test('v3 dispatcher requires one canonical marker and minimum write permission', () => {
...
test('v3 registered workflow exposes boolean certificate input and direct exact-main dispatch', () => {
...
test('v3 dispatcher never accesses Android signing secrets or private signing material', () => {
...
test('v3 certificate export remains production-protected and exact-main bound', () => {

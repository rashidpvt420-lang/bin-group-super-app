import { Z as isString, V as isNumber$1, T as isNan, H as get, U as isNil, W as isObject, R as isFunction, l as clsx, S as Symbol$1, aJ as upperFirst, aG as symbolWye, aF as symbolTriangle, aE as symbolStar, aD as symbolSquare, aC as symbolDiamond, aB as symbolCross, aA as symbolCircle, aI as uniqBy, aq as sortBy, aH as throttle, D as Decimal, N as invariant, i as band, a1 as linear, ae as point, x as d3Scales, a7 as min, a5 as max, ao as shapeStack, av as stackOrderNone, au as stackOffsetWiggle, at as stackOffsetSilhouette, as as stackOffsetNone, ar as stackOffsetExpand, G as flatMap, Q as isEqual, a0 as last, am as shapeArea, an as shapeLine, ax as stepBefore, aw as stepAfter, w as curveStep, v as curveNatural, a9 as monotoneY, a8 as monotoneX, t as curveLinear, u as curveLinearClosed, k as bumpY, j as bumpX, q as curveBasis, s as curveBasisOpen, r as curveBasisClosed, X as isPlainObject, O as isBoolean, ah as range$1, C as every, a2 as mapValues, a6 as memoize$1, F as find, ap as some, E as EventEmitter } from "./vendor-BnDTTxTC.js";
import { ck as reactExports, cm as reactIsExports, bd as React, a as Animate } from "./react-vendor-DgRRuFJT.js";
...
function getValidInterval(_ref) {
  var _ref2 = _slicedToArray$5(_ref, 2), min2 = _ref2[0], max2 = _ref2[1];
...
function getNiceTickValuesFn(_ref3) {
  var _ref4 = _slicedToArray$5(_ref3, 2), min2 = _ref4[0], max2 = _ref4[1];
  var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var count = Math.max(tickCount, 2);
  var _getValidInterval = getValidInterval([min2, max2]), _getValidInterval2 = _slicedToArray$5(_getValidInterval, 2), cormin = _getValidInterval2[0], cormax = _getValidInterval2[1];
...
function getTickValuesFixedDomainFn(_ref7, tickCount) {
  var _ref8 = _slicedToArray$5(_ref7, 2), min2 = _ref8[0], max2 = _ref8[1];
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var _getValidInterval5 = getValidInterval([min2, max2]), _getValidInterval6 = _slicedToArray$5(_getValidInterval5, 2), cormin = _getValidInterval6[0], cormax = _getValidInterval6[1];
  if (cormin === -Infinity || cormax === Infinity) {
    return [min2, max2];
  }
  if (cormin === cormax) {

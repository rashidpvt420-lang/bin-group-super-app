...
""",
    'coordinate-free persistent STOP storage',
)
tracking = replace_once(
    tracking,
...
privacy_test_path = Path('tests/launch/gps-queue-durability-privacy.test.mjs')
privacy_test = privacy_test_path.read_text(encoding='utf-8')
privacy_test = replace_once(
    privacy_test,
